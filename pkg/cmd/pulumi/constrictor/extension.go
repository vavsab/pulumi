...
// AddExtensionFlag registers the shared --extension flag. When set, the command
// adds an extension layered onto a base provider rather than a replacement; the
// flag's value carries the extension's provider-defined parameters.
